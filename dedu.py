...
@click.option(
    "--dry-run", is_flag=True, default=True, show_default=True, help="Find duplicates, without removing anything."
)
@click.option("--report", default="duplicates.json", type=Path, show_default=True, help="Path to result file")
@click.option(
    "--max-concurrent", type=int, default=20, show_default=True, help="Maximum number of concurrent dedu.py jobs."
)
